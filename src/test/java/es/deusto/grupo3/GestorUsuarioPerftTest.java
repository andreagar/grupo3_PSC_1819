...
public class GestorUsuarioPerftTest {
    ...
    public void testchequearTablaUsuario() throws Exception{
		Thread.sleep(100);
    }
    ...
    public void testcambiarContrasenya() throws Exception{
		Thread.sleep(100);
    }
	
	@Test
	@PerfTest(invocations = 1000, threads = 20, duration=1000)
	@Required(max = 300, average = 116, median=300)
